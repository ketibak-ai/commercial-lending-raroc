...
def engine_config() -> dict:
    ...
    return {
        ...
        "sofrCurve": sorted(C.SOFR_CURVE.items()), "lpCurve": sorted(C.LIQUIDITY_PREMIUM_CURVE.items()),
        "ustCurve": sorted(C.UST_CURVE.items()), "primeRate": C.PRIME_RATE,
        "floatingIndexTenor": C.FLOATING_INDEX_TENOR,
